package com.mutia.datamahasiswa
...
import com.mutia.datamahasiswa.adapter.MahasiswaAdapter
import com.mutia.datamahasiswa.databinding.ActivityListMahasiswa2Binding

class listMahasiswaActivity : AppCompatActivity() {
    private lateinit var binding: ActivityListMahasiswa2Binding
    private lateinit var db: MahasiswaDatabaseHelper
    private lateinit var mahasiswaAdapter: MahasiswaAdapter
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityListMahasiswa2Binding.inflate(layoutInflater)
